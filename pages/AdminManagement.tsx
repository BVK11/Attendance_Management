...
import { facultyService, studentService, mentorService } from '../services/storageService';
...
const AdminManagement: React.FC = () => {
    ...
    useEffect(() => {
        const loadData = () => {
            ...
            setStudents(studentService.getAll().filter(s => s.department === dept));
            setFaculty(facultyService.getAll().filter(f => f.department === dept));
            setMentors(mentorService.getAll().filter(m => m.department === dept));
        };
