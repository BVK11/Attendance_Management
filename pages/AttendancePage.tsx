...
import { studentService, attendanceService, alertService } from '../services/storageService';
...
const AttendancePage: React.FC = () => {
    ...
    useEffect(() => {
        if (department && section) {
            const classStudents = studentService.getAll().filter(s => s.department === department && s.section === section);
