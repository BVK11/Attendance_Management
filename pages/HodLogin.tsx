                ...
                <Card className="p-8 space-y-4 rounded-xl shadow-lg">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 pt-4">
                        <Input 
                            ...
                            required
                            autoComplete="email"
                            placeholder="Email (e.g. ramesh.kumar@college.edu)"
                        />
                         <Input 
                            id="password"
                            type="password"
                        ...
                        <Button type="submit" className="w-full !mt-6 bg-[#0D2B4F] hover:bg-[#1E487B] text-white">Sign in</Button>
                    </form>
                </Card>
            </div>
        </div>
